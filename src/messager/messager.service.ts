import { ClientConfig, liff, MessageAPIResponseBase, messagingApi, webhook } from '@line/bot-sdk';
...
import { PoHeader } from 'src/document/dto/poReleaseItems.dto';
import { LiffClient } from '@line/bot-sdk/dist/liff/api';
...
export class MessagerService {
  ...
  async getRegisterMenu(replyToken: string) {
    const bodyText = "Please register to continue";
    const actionLabel = "Register";
    const actionUrl = process.env.NODE_APP_BASE_URL + "register"
  ...
  getPrBubbles(doc: prRequisitionItem): FlexBubble {
...
function getliffUrl(url) {

  // return 'https://liff.line.me/2004765780-YdWoDKaE?url='+url
  return url
}
